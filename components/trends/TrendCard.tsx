  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <span className={`flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-tighter ${isHighSaturation ? 'bg-red-500/20 text-red-400' : 'bg-green-500/20 text-green-400'
          }`}>
          {isHighSaturation && <ExclamationTriangleIcon className="w-3 h-3" />}
